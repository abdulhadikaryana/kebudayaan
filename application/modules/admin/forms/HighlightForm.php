...
class Admin_Form_HighlightForm extends Zend_Form {
  ...
  public $highlightStatus;    public $hightlightLanguage;

  public function init() {  	$lang = array("multiOptions" => array(		1 => "IN",		2 => "EN",	));
    ...
    $this->highlightStatus->removeDecorator('Label');			$this->hightlightLanguage = $this->createElement('select', 'highlightLanguage', $lang);    $this->hightlightLanguage->removeDecorator('HtmlTag');    $this->hightlightLanguage->removeDecorator('DtDdWrapper');    $this->hightlightLanguage->removeDecorator('Label');
