 ...
 */
class CultureController extends Budpar_Controller_Destination {
...
//    $related = $destinationDb->getRelatedCulture($poi_id,$this->_languageId);
    ...
    public function getthereAction() {
        ...
        if ($this->_request->isXmlHttpRequest()) $this->render('detail');
        else $this->view->tab = 'getthere';
        $this->render('index');
        //$this->render('destination');
    }
    ...
    public function postsAction() {
        ...
        $this->view->headLink()->headLink(array(
            'rel' => 'canonical',
            'href' => Zend_Controller_Front::getInstance()->getRequest()->getScheme() . '://' . Zend_Controller_Front::getInstance()->getRequest()->getHttpHost() . $this->view->url(array(), $this->_languageId == 1 ? 'kebudayaan' : 'culture', true)
                ), 'PREPEND');
    }
    ...
    public function redirectAction() {
        ...
        $url = $this->view->url(array(
            'destId' => $this->getParam('destId'),
            'slug' => $this->getParam('slug')
                ), $this->_languageId == 1 ? 'detail-kebudayaan' : 'culture-detail');
