...

{
...

  {
    ...
    $where = $this->getAdapter()->quoteInto('category_id = ?',
  ...
  public function getQueryAllBylanguage($filter = null, $param = null,
...

  {
    ...
    $select = $this->select()
            ...
            ->join(array('cd' => $this->_catdes),

                   'cd.category_id = c.category_id', array('cd.name'))
  ...
  public function getAllWithDescByIdLang($category_id,
...

  {
    ...
    $select = $this->select()
            ...
            ->join(array('catdes' => $this->_catdes),

                   'cat.category_id = catdes.category_id',
  ...
  public function getAllCategoryIdNameByLangIdForSelect($language_id,
  ...
  public function getAllParentIdNameForSelectByLangId($language_id = 1,
  ...
  public function getAllParentIdNameForSelectByLangIdIndo($language_id = 2,
...

  {
    ...
    $query = $this->select()
            ...
            ->join($this->_catdes,
                   ...
                   "{$this->_name}.category_id = {$this->_catdes}.category_id",
...

  {
    ...
    foreach ($data1 as $counter => $row) {
      ...
      $listCategory[$counter]['child']       = $this->getCategoryChildList($row['category_id'],
...

  {
    ...
    $query = $this->select()
            ...
            ->join(array('poi' => $this->_poi),

                   'cat.category_id = poi.main_category',

                   array('COUNT(poi.poi_id) AS total_culture'))
  ...
  public function getAllChildIdNameByParentIdLangId($parent_id = null,
...
//        /echo $select->__toString();/
...

  {
    ...
    $query = $this->select()
            ...
            ->join($this->_catdes,
                   ...
                   "{$this->_catdes}.category_id = {$this->_name}.category_id")
...

  {
    ...
    $query = $this->select()
            ...
            ->joinLeft(array('poi' => $this->_poi),

                       "{$this->_name}.category_id = poi.main_category",
            ...
            ->where("poi.status = ?",
                    ...
                    Model_DbTable_Destination::PUBLISH)
...
//         echo $query->__toString();
...

  {
    ...
    $query = $this->select()
            ...
            ->joinLeft(array('cat2' => $this->_name),

                       "cat2.parent_id = {$this->_name}.category_id",

                       array())

            ->joinLeft(array('poi' => $this->_poi),

                       "{$this->_name}.category_id = poi.main_category OR cat2.category_id = poi.main_category",

                       array('COUNT(DISTINCT(poi.poi_id)) AS total_culture'))
  ...
  public function getSubCategoriesWithCounter($parent_id = 1,
