...
class Admin_ActivityindoController extends Library_Controller_Backend
{
    /**
     * IS: -
     * FS: -
    ...
    public function createAction()
    {
        ...
        if($this->getRequest()->isPost())
        {
            if($form->isValid($_POST))
            {
                ...
                $this->_redirect($this->view->rootUrl('/admin/activityindo/'));
            }
        }
        ...
        if($this->getRequest()->isPost())
        {
            if($form->isValid($_POST))
            {
                if($language_id!=2)
                {
                    ...
                    $indo = $table_category_desc->checkForEnglish($activity_id);
                    if($indo)
                    {
                        $data = array(
                                'category_id' => $activity_id,
                        ...
                        $table_category_desc->updateCategory($data,$activity_id,1);
                    }else
                    {
                        $data = array(
                                'category_id' => $activity_id,
                ...
                }else
                {
                    ...
                    $table_category_desc->updateCategory($data2,$activity_id,2);
                }
