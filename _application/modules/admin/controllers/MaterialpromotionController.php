...
class Admin_MaterialpromotionController extends Library_Controller_Backend {
  ...
  public function indexAction() {
    ...
    $select = $material_desc->getQueryAll($filter, $param);
  ...
  public function createAction() {
    ...
    if ($this->getRequest()->isPost()) {
      if ($form->isValid($_POST)) {
        ...
        $this->_redirect($this->view->rootUrl('/admin/materialpromotion/'));
      }
    }
    $this->view->form = $form;
  }
  ...
  public function editAction() {
    ...
    if ($this->getRequest()->isPost()) {
      if ($form->isValid($_POST)) {
        ...
        if ($language_id != 1) {
          $indo = $materialdesc->checkForIndo($material_id);
          if ($indo) {
            $data2 = array(
                'material_id' => $material_id,
