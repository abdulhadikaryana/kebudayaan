...
class Admin_PageindoController extends Library_Controller_Backend
{
    /**
     * IS: -
     * FS: -
    ...
    public function editAction()
    {
        ...
        if($this->getRequest()->isPost())
        {
            ...
            $table_static->updateStaticContent($data,$static_id,$language_id);
            $this->loggingaction('page', 'edit', $static_id, $language_id);
            $this->_flash->addMessage('1\Page Indo Update Success!');
            $this->_redirect($this->view->rootUrl('/admin/pageindo/'));
        }
