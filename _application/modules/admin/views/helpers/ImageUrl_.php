...
class Budpar_View_Helper_ImageUrl extends Zend_View_Helper_Abstract
{
    ...
    {
        //$this->_base = CDN_URL . Zend_Controller_Front::getInstance()->getBaseUrl() .'/media/images';
        $this->_base = Zend_Controller_Front::getInstance()->getBaseUrl() .'/public/media/images';
    }
