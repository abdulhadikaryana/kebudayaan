 ...
 *
 */
class Zend_View_Helper_EventDestinationList extends Zend_View_Helper_Abstract
{
	...
	public function EventDestinationList($event_id) 
    {
    	$destination_list  = $this->table_poitoevent->getAllPoiNameByEventId($event_id,1);
