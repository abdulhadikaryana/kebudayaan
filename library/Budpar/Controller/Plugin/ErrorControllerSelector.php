<?php
class Budpar_Controller_Plugin_ErrorControllerSelector extends Zend_Controller_Plugin_Abstract
{
...
$front = Zend_Controller_Front::getInstance();
$front->registerPlugin( new Budpar_Controller_Plugin_ErrorControllerSelector() );
?>