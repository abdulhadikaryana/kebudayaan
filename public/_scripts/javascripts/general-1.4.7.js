...
function changeLanguage(lang, link)
{
	...
	if ((lang == 'fr')||(lang == 'de')||(lang == 'nl')||(lang == 'jp')||(lang == 'cn')||(lang == 'ru')||(lang == 'id')||(lang == 'en'))
    {
        switch(lang)
        {
            ...
            case 'id' : window.location = linkBaru;
                      break;   
            case 'nl' : window.open('http://www.toerisme-indonesie.nl/');
                      break;
            ...
            case 'de' : window.open('http://www.tourismus-indonesien.de');
                      break;
            case 'fr' : window.open('http://www.tourisme-indonesie.fr');
                      break;
        }
    }else{
