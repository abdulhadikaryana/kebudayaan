...
add_action('widgets_init','eff_ads250');

function eff_ads250() {
	register_widget('eff_ads250');
	
	}

class eff_ads250 extends WP_Widget {
	function eff_ads250() {
			
		$widget_ops = array('classname' => 'eff_ads250','description' => __('Widget display 250*250 Ads','framework'));
		$this->WP_Widget('eff_ads250',__('Widget - Ads 250*250','framework'),$widget_ops);
