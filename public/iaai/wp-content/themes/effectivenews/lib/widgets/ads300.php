...
add_action('widgets_init','eff_ads300');

function eff_ads300() {
	register_widget('eff_ads300');
	
	}

class eff_ads300 extends WP_Widget {
	function eff_ads300() {
			
		$widget_ops = array('classname' => 'eff_ads300','description' => __('Widget display 300*250 Ads','framework'));
		$this->WP_Widget('eff_ads300',__('Widget - Ads 300*250','framework'),$widget_ops);
