...
add_action('widgets_init','eff_ads120x');

function eff_ads120x() {
	register_widget('eff_ads120x');
	
	}

class eff_ads120x extends WP_Widget {
	function eff_ads120x() {
			
		$widget_ops = array('classname' => 'eff_ads120x','description' => __('Widget display 120*600 Ads','framework'));
		$this->WP_Widget('eff_ads120x',__('Widget - Ads 120*600','framework'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array( 'title' => __('advertisement', 'framework'), 
			'img' => EFF_IMG.'/ads120x.png', 
			'link' => '#',
			'img2' => EFF_IMG.'/ads120x.png', 
			'link2' => '#'
