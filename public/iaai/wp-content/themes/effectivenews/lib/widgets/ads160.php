...
add_action('widgets_init','eff_ads160');

function eff_ads160() {
	register_widget('eff_ads160');
	
	}

class eff_ads160 extends WP_Widget {
	function eff_ads160() {
			
		$widget_ops = array('classname' => 'eff_ads160','description' => __('Widget display 160*600 Ads','framework'));
		$this->WP_Widget('eff_ads160',__('Widget - Ads 160*600','framework'),$widget_ops);
