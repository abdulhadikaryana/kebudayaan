...
add_action('widgets_init','eff_ads125');

function eff_ads125() {
	register_widget('eff_ads125');
	
	}

class eff_ads125 extends WP_Widget {
	function eff_ads125() {
			
		$widget_ops = array('classname' => 'eff_ads125','description' => __('Widget display 125*125 Ads','framework'));
		$this->WP_Widget('eff_ads125',__('Widget - Ads 125*125','framework'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array( 'title' => __('advertisement', 'framework'), 
			'img' => EFF_IMG.'/ads125.png', 
			'link' => '#',
			'img2' => EFF_IMG.'/ads125.png', 
			'link2' => '#',
			'img3' => EFF_IMG.'/ads125.png', 
			'link3' => '#',
			'img4' => EFF_IMG.'/ads125.png', 
			'link4' => '#',
