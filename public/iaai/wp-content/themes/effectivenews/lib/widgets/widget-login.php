<?php
add_action( 'widgets_init', 'eff_login_widget' );
function eff_login_widget() {
...
class login_widget extends WP_Widget {
	...
	function login_widget() {
		...
		$this->WP_Widget('login-widget',__('Widget - Login','framework'),$widget_ops);
	}
	...
	function form( $instance ) {
		$defaults = array( 'text_html_title' =>__('Login' , 'framework')  );
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>

		<p>
			<label for="<?php echo $this->get_field_id( 'text_html_title' ); ?>"><?php _e('Title : ' , 'framework') ?></label>
