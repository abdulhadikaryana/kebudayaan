...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			if (is_rtl()) {
				wp_enqueue_style( 'eff-rtl', RWMB_CSS_URL . 'rtl.css', RWMB_VER );
			}
			wp_enqueue_script( 'customjs', RWMB_JS_URL . 'custom.js', RWMB_VER, true );
			wp_enqueue_script( 'tools', RWMB_JS_URL . 'jquery.tools.min.js', RWMB_VER, true );
