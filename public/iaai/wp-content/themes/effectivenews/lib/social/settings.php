...
function sh_sb_settings_page(){
	...
	if( !current_user_can( 'manage_options' ) ): 
		wp_die( __( 'Insufficient permissions', 'theme' ) );
	else:
		sh_sb_check_new();
		sh_sb_check_update();
	endif;
			...
			<div id="menu-settings-column" class="metabox-holder">
				<div id="side-sortables" class="meta-box-sortables">
						...
						<div class="inside customlinkdiv">
							<form action="" method="post" id="create-form">
								...
								<p class="sh_sb-border-bottom"><label for="sh_sb_icon_new" class="upload-field howto">
									<span><?php _e( 'Icon', 'theme' ); ?></span>
									<input type="text" value="" name="sh_sb_icon" id="sh_sb_icon_new" class="code" />
									
									<a href="#" id="upload_image_button"><?php _e( 'Upload', 'theme' ); ?></a>
									
									<span class="sh_sb-clearfix"></span>
								</label></p>
								
								<p><input type="submit" name="sh_sb_new_item" id="sh_sb_new_item" value="<?php _e( 'Create Item', 'theme' ); ?>" class="button-primary" /></p>
					...
					<div class="postbox">
						...
						<div class="handlediv" title="Click to toggle"><br></div>
						<h3 class="hndle"><?php _e( 'Icon Bucket', 'theme' ); ?></h3>
						...
						<div id="sh_sb-icon-tabs" class="inside posttypediv">
							...
							<div id="default-icons" class="tabs-panel">
								<?php echo sh_sb_get_icons( plugin_dir_path( __FILE__ ), EFF_SOC ); ?>
							</div>
							
							<p><?php _e( "Select an icon above and its URL will be automatically entered for you.", 'theme' ); ?></p>
				...
				<div id="post-body-content" class="postbox">
					...
					?>	
						...
						<form action="" method="post" class="listings-form">
							<table cellpadding="0" cellspacing="0">
								<thead>
									<tr>
										<th class="icon-col"><?php _e( 'Icon', 'theme' ); ?></th>
										<th><?php _e( 'Link', 'theme' ); ?></th>
										<th><?php _e( 'Title', 'theme' ); ?></th>
								...
								<tbody class="sortable">
									...
									<tr>
										...
										<td class="actions-col">
											<a href="#" class="sh_sb-move"><img src="<?php echo EFF_SOC; ?>/images/move.png" alt="Move" /></a>
											<a href="#" class="sh_sb-delete"><img src="<?php echo EFF_SOC; ?>/images/delete.png" alt="Delete" /></a>
										</td>
									</tr>
								...
								<tfoot>
									<tr>
										<td colspan="2">
											...
											<label for="sh_sb_title_only"><?php _e( 'Display the titles instead of images' , 'theme' ); ?></label>
										</td>
					...
					<?php else: ?>
						...
						<div class="empty-message">
							<p><?php _e("You don't have any items in your bar, why not create some?", "theme"); ?></p>
						</div>
...
function sh_sb_check_update(){
	...
	?>
		...
		<div id="message" class="updated">
			<p><?php _e( 'Items updated', 'theme' ); ?></p>
		</div>
