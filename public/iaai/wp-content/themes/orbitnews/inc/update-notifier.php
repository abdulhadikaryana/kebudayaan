...
define( 'NOTIFIER_XML_FILE', 'http://www.nextwpthemes.com/themes/orbitnews-wp/notifier.xml' );  // path to notifier.xml
define( 'NOTIFIER_CACHE_INTERVAL', 6 ); // interval to refresh the xml in database with remote XML (default 6 hours)
define( 'NOTIFIER_THEMEFOREST_USERNAME', 'jetonr' ); // your themeforest username
          ...
          <tbody id="the-list">
              ...
              <td class="column-description desc ntf_border">
                  ...
                  <ol>
                      ...
                      <li><p>Login to your <a href="http://themeforest.net/?ref=<?php echo NOTIFIER_THEMEFOREST_USERNAME; ?>">Themeforest</a> account, go to <strong>Settings -> API Keys</strong>, select and copy your API Key </p></li>
