...
$(function() {
    ...
    // Slideshow
    $('#slideshow').load(urlForSlider, sliderCallback);
	...
	trackJsEvent('login', 'click', 'Open Login Form');	
    });
...
/**
 * Fungsi callback yang dipanggil untuk slider header image
 */
...
/**
 * Fungsi untuk slider header image
 */
