...
(function($)
{
	...
	$(document).ready(function()
	{
		...
		$('.arbo .toggle, .collapsible-list li:has(ul) > :first-child, .collapsible-list li:has(ul) > :first-child + span').live('click', function(event)
		{
			// Toggle style
		...
		// Accordions effect
		$('dl.accordion dt').live('click', function()
		{
